...
fivejournalists = journalists.sample(5)
#Tweet tagging the 5 journalists handles picked
fivejournalists.each do |user|
  client.update("#{user} Tu vas bien ? #bonjour_monde @the_hacking_pro")
end

#Like the last 25 tweets published containg the #bonjour_monde
...
#Launch a stream to live like tweets with the #bonjour_monde and live follow the user
